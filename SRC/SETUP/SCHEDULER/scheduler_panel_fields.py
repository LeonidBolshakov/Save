"""Контроллер полей SchedulePanel.

Связывает логические поля конфигурации задачи с виджетами UI,
переменными окружения и валидаторами.
"""
...
class TaskFieldsController:
    """Управляет описанием полей задачи и применением значений к UI."""
    ...
    def build_descr_task_fields(
        ...
        Каждый объект содержит ссылку на атрибут UI, ключ в env,
